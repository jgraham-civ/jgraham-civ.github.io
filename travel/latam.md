...
<div class="travel-nav">
    <div class="travel-box current">
        <span class="left">latin america</span>
        <span class="right">2025</span>
    </div>
    <hr style="border: 0; height: 1px; background-color: #c9c9c9; width: 100%">
    <a href="{{ '/travel/euro' | relative_url }}">
        <div class="travel-box secondary">
            <span class="left">> central and eastern europe</span>
...
<div class="travel">
  <img src="{{ '/assets/images/latam-1.jpg' | relative_url }}" alt="LATAM travel 1">
  <div class="toggle-container">
    ...
    <div class="toggle-content">
        ...
        <p>Like Chichén Itzá, Tikal was a major urban centre in pre-Columbian Mayan civilisation, though the zenith of its influence came earlier than the former and was more in line with that of Mayan civilisation as a whole. Through war, trade, and diplomacy, it rose to dominate the region and grew to an estimated population of 90,000. Chief among its adversaries was not Chichen Itza, but Calakmul (in modern day Mexico), and power swung between them in a fierce, centuries-long rivalry.</p>
        <p>The vegetation that has since reclaimed Tikal also gives it a starkly different atmosphere to Chichen Itza. Spider monkeys and coatis roam freely here, and getting between the many temples takes you along dense jungle trails. The top of Temple V offers a jaw-dropping panorama of the other temples rising above the tree canopy. Centuries ago there would have been no canopy to rise above— streets and farmland would have spread in every direction— but the view as it is now remains spectacular and was used by George Lucas used to shoot the arrival of the Millenium Falcon on Yavin IV in Star Wars: A New Hope. As someone who grew up on Star Wars, I am biased, but Tikal a must-visit.</p>
    </div>
  </div>
  ...
  <img src="{{ '/assets/images/latam-4.jpg' | relative_url }}" alt="LATAM travel 4">
  <div class="toggle-container">
    <div class="toggle-box read-toggle">READ</div>
    <div class="toggle-content">
  ...
  <img src="{{ '/assets/images/latam-5.jpg' | relative_url }}" alt="LATAM travel 5">
  <div class="toggle-container">
    <div class="toggle-box read-toggle">READ</div>
    <div class="toggle-content">
        ...
        <p>The uncontested highlight of our short stay here was our hike around the aforementioned Cocora Valley. From Salento’s central square, we hopped on the back of a 4x4 which took us 20 minutes to the hike’s start point. Besides being maybe the greenest place I’ve ever been, here one can find Colombia’s famous wax palms. These trees are extremely tall (regularly growing to heights of 45m), but their trunks and leaves grow no larger than any normal palm tree, making them appear comically thin and veritably alien. Our hike took us up into the mountains for stunning vistas and back into the valley along a stream criss-crossed by rope bridges.</p>
    </div>
  </div>
  ...
  <div class="toggle-container">
    ...
    <div class="toggle-content">
        ...
        <p>Due to frequent earthquakes the monastery has undergone many reconstructions, extensions, and modifications, existing today as a kind of labyrinth of corridors, vaults, sleeping quarters, courtyards, archways, and prayer rooms. Where most of the old town leaves the natural off-white colour of sillar as is, entire sections of the monastery have been coated with blocks of orange and royal blue dyes. Painted onto the walls surrounding the courtyards are still life and religious scenes, while the interiors are filled out with framed paintings and simple furniture. The monastery is complete with outdoor washing basins and a small garden, in which we felt very much isolated from the city around us.</p>
        <p>The nuns which have long lived here are an alarmingly devout bunch. Wall-mounted placards talk of the nuns’ practices, which included (of course) plenty of silent prayer and meditation, but also fasting, sleep deprivation, adopting uncomfortable postures, and wearing “barbed-wire undergarments”. By “maintaining the body with the minimum necessary to prevent its collapse”, the nuns sought to achieve a “mystic betrothal” with Christ. Nowadays, 21 sisters aged between 25 and 100 live in a small, closed-off section of the monastery. I hope they are not still taking themselves to such extremes!</p>
    </div>
  </div>
  ...
  <div class="toggle-container">
    <div class="toggle-box read-toggle">READ</div>
    <div class="toggle-content">
        <p>[Left: Hikers walk along a mountainside path overlooking the Red Valley; Right: A view of The Red Valley from near said path]</p>
        <p><b>The Red Valley:</b></p>
        <p>The Red Valley lies deep in the Andes, a four hour drive from Cusco and a further hour's hike from the nearest road, though at 5000 metres, the hike feels longer than that.</p>
        <p>The mountain peaks and soil around them are a dull taupe colour but transition into a deep red as you follow the slopes down into the valley. Large parts of the valley floor are covered in a lime green moss and dotted with grazing vicunas.</p>
    </div>
  </div>
  ...
  <div class="toggle-container">
    ...
    <div class="toggle-content">
        ...
        <p>Anyone who visits Bolivia will also notice many indigenous Aymara and Quechua women, known as cholitas, wearing pleated, puffed skirts (known as polleras), shawls, and (typically) bowler hats, with their hair tied into two long braids. Historically marginalised, cholitas were barred from certain public spaces, given limited career opportunities, and prohibited from taking public transport. Their civil rights movement, ongoing since the 60s, has made significant progress following the election of Bolivia’s first indigenous president in 2006. Nowadays, cholitas work as teachers, bus drivers, business owners, politicians, journalists, and even… wrestlers? One of the more bizarre cultural phenomena to have emerged from La Paz pits cholitas against one another in choreographed matches, performing throws, holds, and jumps (including one from a viewing balcony) straight out of the WWE playbook. It was an awesome spectacle to witness firsthand.</p>
        <p>While inequality remains—many of the beggars we saw were cholitas—it is encouraging to learn about their rise as prominent cultural and professional figures.</p>
  ...
  <div class="toggle-container">
    ...
    <div class="toggle-content">
        ...
        <p>This corner of southwestern Bolivia is busy with geological activity, creating natural hot springs, geysers, lakes, deserts and volcanoes—all at altitudes of 4200 to 5400 metres. It is barren and brutal; vegetation is scarce, and the temperature swings wildly between day and night but averages just three degrees Celcius. Human activity here centres around mining, the military, and tourism, with further projects underway to develop geothermal power stations. Often, however, the only evidence of people would be distant clouds of dust being kicked up by four-by-fours shuttling tourists. I previously described the Paracas National Reserve as Mars-like, but I would say this comes closer.</p>
        <p>The altitude, temperature extremes, and lack of rainfall make for incredibly harsh living conditions, but here we saw several herds of roaming vicunas, thousands-strong colonies of flamingos, and sleepy viscachas sheltering in rock crevices.</p>
    </div>
  </div>
...
document.addEventListener("DOMContentLoaded", function() {
    const toggles = document.querySelectorAll(".abstract-toggle, .read-toggle");

    toggles.forEach(toggle => {
        toggle.addEventListener("click", function() {
            const contentBox = this.closest(".research-project, .toggle-container")
                                   .querySelector(".toggle-content");
            
            contentBox.style.display = contentBox.style.display === "block" 
                                       ? "none" 
                                       : "block";
        });
    });
